<div class="menu-box"><br><br>
				<div class="heading-title text-center">
						<h2>Detail Produk UMKM Olaten </h2>
					</div>
		<div class="card-body">
				<div class="row">
					<div class="col-md-5">
						<img src="<?php echo base_url('assets/images/olaten/' .$detail->foto_produk)?>" style="width: 500px">
					</div>
					<div class="col-md-7">
						<table class="table table-no-bordered table-striped">
							...
							<tr>
								<td>
									<a class="btn btn-danger" href="<?php echo base_url();?>olaten" >
